...
public class FragmentArticle12 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_fragment_article12, container, false);
        textView1=view.findViewById(R.id.textretourarticle);
        textView2=view.findViewById(R.id.nomarticle12);
        textView3=view.findViewById(R.id.textArticle12);
        shareBody="CONSTITUTION DE LA REPUBLIQUE DU SENEGAL DU 22 JANVIER 2001";



        String s=" Tous les articles ";
        SpannableString ss=new SpannableString(s);
        ClickableSpan clik=new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                onfragmentRetour.fragmentRetour();
            }
        };
        ...
        textFavoris=view.findViewById(R.id.textFavoris1);
        ...
        textShare=view.findViewById(R.id.textShare1);
        String s1= "";
    ...
    public interface OnfragmentRetour{
    ...
    public void onAttach(Context context) {
        ...
        try{
            onfragmentRetour=(OnfragmentRetour)activity;
        }
        catch (Exception  e){}
    }
}
